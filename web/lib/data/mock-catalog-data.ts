...
export const MOCK_CATALOG_GROUPS: CatalogGroup[] = [
  ...
  group('dec-security', ALL_EVENT_TYPES, 'decoration', 'Bouncers & Security', null, 0, false, null, 5),
...
export const MOCK_CATALOG_ITEMS: CatalogItem[] = [
  ...
  item({ id: 'dec-venue-entrance-passage', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Entrance Passage Decoration', description: 'Decorated walkway leading up to the venue.', imageUrl: '', packageLevel: 'normal', price: 8000, unit: 'per event', displayOrder: 1 }),
  item({ id: 'dec-venue-entrance-door', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Venue Entrance Door Decoration', description: 'Decoration for the main venue entrance door.', imageUrl: '', packageLevel: 'normal', price: 5000, unit: 'per event', displayOrder: 2 }),
  item({ id: 'dec-venue-photo-booth', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Photo Booth', description: 'Decorated photo booth setup for guests and memorable pictures.', imageUrl: '', packageLevel: 'normal', price: 6000, unit: 'per event', displayOrder: 3 }),
  item({ id: 'dec-venue-stage', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Stage Decoration', description: 'Customized stage setup for the main event.', imageUrl: '', packageLevel: 'gold', price: 30000, unit: 'per event', displayOrder: 4 }),
  item({ id: 'dec-venue-muhurtha-mantapa', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Muhurtha Manthapa Decoration', description: 'Traditional decoration of the muhurtha manthapa for the ceremony.', imageUrl: '', packageLevel: 'gold', price: 25000, unit: 'per event', displayOrder: 5 }),
  item({ id: 'dec-venue-saptapadi', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Saptapadi', description: 'Traditional setup for the Saptapadi ceremony.', imageUrl: '', packageLevel: 'normal', price: 6000, unit: 'per event', displayOrder: 6 }),
  item({ id: 'dec-venue-homa-gunda', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Homa Gunda', description: 'Decorated setup for the Homa Gunda ritual.', imageUrl: '', packageLevel: 'normal', price: 6000, unit: 'per event', displayOrder: 7 }),
  item({ id: 'dec-venue-kashi-yatri', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Kashi Yatri', description: 'Traditional setup for the Kashi Yatra ritual.', imageUrl: '', packageLevel: 'normal', price: 4000, unit: 'per event', displayOrder: 8 }),
  item({ id: 'dec-venue-deepa-alankara', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Deepa Alankara', description: 'Decorative lamp (deepa) arrangement for the venue.', imageUrl: '', packageLevel: 'normal', price: 4000, unit: 'per event', displayOrder: 9 }),
  item({ id: 'dec-venue-special-garlands', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Special Garlands', description: 'Premium special garlands for the ceremony.', imageUrl: '', packageLevel: 'gold', price: 6000, unit: 'per event', displayOrder: 10 }),
  item({ id: 'dec-venue-normal-garlands', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Normal Garlands', description: 'Fresh flower garlands for the ceremony.', imageUrl: '', packageLevel: 'normal', price: 4000, unit: 'per event', displayOrder: 11 }),
  item({ id: 'dec-venue-mogina-jade', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Mogina Jade', description: 'Traditional mogina jade (floral string) decoration.', imageUrl: '', packageLevel: 'normal', price: 3000, unit: 'per event', displayOrder: 12 }),
  item({ id: 'dec-venue-harini-bashinge', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Harini Bashinge', description: 'Traditional Harini Bashinge setup for the ceremony.', imageUrl: '', packageLevel: 'normal', price: 3000, unit: 'per event', displayOrder: 13 }),
  item({ id: 'dec-venue-nadaswaram', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Nadaswaram', description: 'Live Nadaswaram musicians for the ceremony.', imageUrl: '', packageLevel: 'gold', price: 10000, unit: 'per event', displayOrder: 14 }),
  item({ id: 'dec-venue-punjabi-dhol', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Punjabi Dhol / Dole', description: 'Punjabi dhol or dole entertainment for the venue.', imageUrl: '', packageLevel: 'gold', price: 8000, unit: 'per event', displayOrder: 15 }),
  ...
  item({ id: 'dec-welcome-girls-service', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-couple-entry', name: 'Welcome Girls', description: 'Welcome girls to greet and escort guests with flowers and aarti.', imageUrl: '', packageLevel: 'normal', price: 5000, unit: 'per event', displayOrder: 10 }),

  // Bouncers & Security
  item({ id: 'dec-security-bouncers', supportedEventTypes: ALL_EVENT_TYPES, categoryKey: 'decoration', groupId: 'dec-security', name: 'Bouncers & Security', description: 'Professional bouncers and security team for event management.', imageUrl: '', packageLevel: 'gold', price: 8000, unit: 'per event', displayOrder: 1 }),
  item({ id: 'dec-security-entrance-guard', supportedEventTypes: ALL_EVENT_TYPES, categoryKey: 'decoration', groupId: 'dec-security', name: 'Entrance & Parking Security', description: 'Dedicated security personnel for venue entrance checkpoint and parking.', imageUrl: '', packageLevel: 'normal', price: 5000, unit: 'per event', displayOrder: 2 }),
  ...
  // Birthday decoration - Entry Concept
  ...
  // Order: 1. Traditional Photo, 2. Traditional Video, 3. Candid Photo, 4. Cinematic Video, 5. Drone
  ...
  item({ id: 'photo-candid-video', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-deverakarya', name: 'Cinematic Videography', description: 'Cinematic candid videography coverage of the Deverakarya.', imageUrl: '', packageLevel: 'gold', price: 40000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 2 }, displayOrder: 4 }),
  item({ id: 'photo-deverakarya-drone', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-deverakarya', name: 'Drone', description: '4K aerial drone coverage of the Deverakarya ceremony.', imageUrl: '', packageLevel: 'gold', price: 20000, unit: 'per event', displayOrder: 5 }),

  // Wedding photography - Wedding Hall (venue coverage and screens)
  // Order: 1. Traditional Photo, 2. Traditional Video, 3. Candid Photo, 4. Cinematic Video, 5. Drone, 6. LED Wall, 7. Live Streaming, 8. Spotmix
  item({ id: 'photo-hall-traditional-photo', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Traditional Photography', description: 'Classic posed traditional photography for the wedding hall reception.', imageUrl: '', packageLevel: 'normal', price: 15000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 1 }, displayOrder: 1 }),
  ...
  item({ id: 'photo-hall-traditional-video', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Traditional Videography', description: 'Classic full-event traditional videography of the wedding hall reception.', imageUrl: '', packageLevel: 'normal', price: 15000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 1 }, displayOrder: 3 }),
  item({ id: 'photo-hall-candid-video', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Cinematic Videography', description: 'Cinematic candid videography coverage of the wedding hall reception.', imageUrl: '', packageLevel: 'gold', price: 40000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 2 }, displayOrder: 4 }),
  item({ id: 'photo-wedding-live-streaming', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Live Streaming', description: 'Live stream the wedding for guests who cannot attend.', imageUrl: '', packageLevel: 'premium', price: 15000, unit: 'per event', displayOrder: 5 }),
  item({ id: 'photo-led-wall', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'LED Wall', description: 'Live LED screen stage backdrop display.', imageUrl: '', packageLevel: 'premium', price: 30000, unit: 'per event', displayOrder: 6 }),
  item({ id: 'photo-drone', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Drone', description: '4K aerial drone coverage of the venue and celebrations.', imageUrl: '', packageLevel: 'gold', price: 20000, unit: 'per event', displayOrder: 7 }),
  item({ id: 'photo-hall-spotmix', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Spotmix', description: 'Live multi-camera spot mixing and switcher setup for stage display.', imageUrl: '', packageLevel: 'premium', price: 15000, unit: 'per event', displayOrder: 8 }),
  ...
  item({ id: 'photo-prewedding-photographer', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-prewedding-services', name: 'Photographer', description: 'Dedicated photographer for the pre-wedding shoot.', imageUrl: '/forest-pre-wedding-shoot/forest-shoot-01.jpeg', images: ['/forest-pre-wedding-shoot/forest-shoot-01.jpeg', '/forest-pre-wedding-shoot/forest-shoot-02.jpeg', '/forest-pre-wedding-shoot/forest-shoot-03.jpeg'], packageLevel: 'normal', price: 20000, unit: 'per event', displayOrder: 1 }),
  item({ id: 'photo-prewedding-cinematic-video', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-prewedding-services', name: 'Cinematic Video', description: 'Cinematic video coverage of the pre-wedding shoot.', imageUrl: '/forest-pre-wedding-shoot/forest-shoot-04.jpeg', images: ['/forest-pre-wedding-shoot/forest-shoot-04.jpeg', '/forest-pre-wedding-shoot/forest-shoot-05.jpeg'], packageLevel: 'gold', price: 30000, unit: 'per event', displayOrder: 2 }),
  item({ id: 'photo-prewedding-drone', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-prewedding-services', name: 'Drone', description: '4K aerial drone coverage for the pre-wedding shoot.', imageUrl: '/forest-pre-wedding-shoot/forest-shoot-06.jpeg', images: ['/forest-pre-wedding-shoot/forest-shoot-06.jpeg', '/forest-pre-wedding-shoot/forest-shoot-07.jpeg'], packageLevel: 'gold', price: 15000, unit: 'per event', displayOrder: 3 }),

  // Photography for every other (non-Wedding) event type - single shared group
  // Order: 1. Traditional Photo, 2. Traditional Video, 3. Candid Photo, 4. Cinematic Video, 5. Drone
  ...
  item({ id: 'photo-other-traditional-video', supportedEventTypes: PHOTOGRAPHY_EVENT_TYPES, categoryKey: 'photography', groupId: 'photo-services', name: 'Traditional Videography', description: 'Classic full-event traditional videography.', imageUrl: '', packageLevel: 'normal', price: 15000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 1 }, displayOrder: 2 }),
  ...
  item({ id: 'addon-music-dj', supportedEventTypes: ALL_EVENT_TYPES, categoryKey: 'additional_services', groupId: 'addon-services', name: 'Music / DJ', description: 'Live DJ and sound setup for the event.', imageUrl: '', packageLevel: 'standard', price: 30000, unit: 'per event', displayOrder: 3 }),
  item({ id: 'addon-nadaswara', supportedEventTypes: ['wedding', 'haldi_function', 'traditional_home_function', 'shrimantha_karya', 'half_saree_function'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Bandset', description: 'Traditional live bandset and musical troupe performance.', imageUrl: '', packageLevel: 'standard', price: 20000, unit: 'per event', displayOrder: 4 }),
  item({ id: 'addon-lighting', supportedEventTypes: ['wedding', 'anniversary', 'get_together', 'other_events'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Lighting', description: 'Ambient event lighting design.', imageUrl: '', packageLevel: 'standard', price: 25000, unit: 'setup', displayOrder: 5 }),
  item({ id: 'addon-invitations', supportedEventTypes: ['wedding'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Invitation Cards', description: 'Custom-designed printed invitations.', imageUrl: '', packageLevel: 'standard', price: 100, unit: 'per card', quantityMode: 'stepper', displayOrder: 6 }),
  item({ id: 'addon-return-gifts', supportedEventTypes: ['wedding', 'birthday', 'reception', 'anniversary', 'get_together', 'housewarming', 'haldi_function', 'traditional_home_function', 'shrimantha_karya', 'half_saree_function'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Return Gifts', description: 'Curated return gifts for guests.', imageUrl: '', packageLevel: 'standard', price: 150, unit: 'per guest', quantityMode: 'stepper', displayOrder: 7 }),
  item({ id: 'addon-transportation', supportedEventTypes: ['wedding', 'bachelor_party'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Transportation', description: 'Guest and family transportation coordination.', imageUrl: '', packageLevel: 'gold', price: 25000, unit: 'per event', displayOrder: 8 }),
  item({ id: 'addon-accommodation', supportedEventTypes: ['wedding'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Guest Accommodation', description: 'Guest accommodation booking coordination.', imageUrl: '', packageLevel: 'gold', price: 5000, unit: 'per room', quantityMode: 'stepper', displayOrder: 9 }),
  item({ id: 'addon-coordination', supportedEventTypes: ['wedding', 'corporate_event', 'reception', 'other_events'], categoryKey: 'additional_services', groupId: 'addon-services', name: 'Event Coordination', description: 'Dedicated day-of event coordinator and team.', imageUrl: '', packageLevel: 'premium', price: 35000, unit: 'per event', displayOrder: 10 }),
  ...
  item({ id: 'addon-anchor', supportedEventTypes: ALL_EVENT_TYPES, categoryKey: 'additional_services', groupId: 'addon-services', name: 'Anchor Service', description: 'Professional event anchor or emcee.', imageUrl: '', packageLevel: 'standard', price: 10000, unit: 'per event', displayOrder: 16 }),
