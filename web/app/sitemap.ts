...
/**
 * Generates the XML sitemap containing only canonical, public, indexable URLs.
 * Omits lastModified when not tracking individual file modification timestamps.
 */
export default function sitemap(): MetadataRoute.Sitemap {
  const publicRoutes = [
    ...
    { path: '/booking', priority: 0.6, changeFrequency: 'monthly' as const },
