...
('cat-general', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'catering', 'Catering', 1, 1, false, NULL, 12, true)
ON CONFLICT (id) DO UPDATE SET supported_event_types = EXCLUDED.supported_event_types;
...
('photo-candid-video', ARRAY['wedding'], 'photography', 'photo-deverakarya', 'Cinematic Videography', 'Cinematic candid videography coverage of the Deverakarya.', '', '[]', 'gold', 40000, 'per event', 'team_size', '{"teamSize": 2}', 4),
...
('photo-drone', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Drone', '4K aerial drone coverage of the venue and celebrations.', '', '[]', 'gold', 20000, 'per event', 'single', '{}', 7),
('photo-led-wall', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'LED Wall', 'Live LED screen stage backdrop display.', '', '[]', 'premium', 30000, 'per event', 'single', '{}', 6),
('photo-wedding-live-streaming', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Live Streaming', 'Live stream the wedding for guests who cannot attend.', '', '[]', 'premium', 15000, 'per event', 'single', '{}', 5),
...
('photo-other-traditional-photo', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'photography', 'photo-services', 'Traditional Photography', 'Classic posed traditional photography coverage.', '', '[]', 'normal', 15000, 'per event', 'team_size', '{"teamSize": 1}', 14),
('photo-other-candid-photo', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'photography', 'photo-services', 'Candid Photography', 'Storytelling candid photography coverage.', '', '[]', 'gold', 35000, 'per event', 'team_size', '{"teamSize": 2}', 15),
('photo-other-traditional-video', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'photography', 'photo-services', 'Traditional Videography', 'Classic full-event traditional videography.', '', '[]', 'normal', 15000, 'per event', 'team_size', '{"teamSize": 1}', 16),
('photo-other-candid-video', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'photography', 'photo-services', 'Cinematic Videography', 'Cinematic candid videography coverage.', '', '[]', 'gold', 40000, 'per event', 'team_size', '{"teamSize": 2}', 17),
('photo-other-drone', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'photography', 'photo-services', 'Drone', '4K aerial drone coverage of the venue and celebrations.', '', '[]', 'gold', 20000, 'per event', 'single', '{}', 18),
...
('photo-hall-traditional-photo', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Traditional Photography', 'Classic posed traditional photography for the wedding hall reception.', '', '[]', 'normal', 15000, 'per event', 'team_size', '{"teamSize": 1}', 1),
('photo-hall-candid-photo', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Candid Photography', 'Storytelling candid photography coverage of the wedding hall reception.', '', '[]', 'gold', 35000, 'per event', 'team_size', '{"teamSize": 2}', 2),
('photo-hall-traditional-video', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Traditional Videography', 'Classic full-event traditional videography of the wedding hall reception.', '', '[]', 'normal', 15000, 'per event', 'team_size', '{"teamSize": 1}', 3),
('photo-hall-candid-video', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Cinematic Videography', 'Cinematic candid videography coverage of the wedding hall reception.', '', '[]', 'gold', 40000, 'per event', 'team_size', '{"teamSize": 2}', 4)
ON CONFLICT (id) DO UPDATE SET supported_event_types = EXCLUDED.supported_event_types;
...
INSERT INTO catalog_items (id, supported_event_types, category_key, group_id, name, description, image_url, images, package_level, price, unit, quantity_mode, display_order) VALUES
('cater-gen-01', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'catering', 'cat-general', 'Standard Buffet Catering', 'Multi-item vegetarian buffet spread.', '', '[]', 'normal', 350, 'per guest', 'single', 1),
('cater-gen-02', ARRAY['engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'catering', 'cat-general', 'Premium Buffet Catering', 'Extended multi-cuisine buffet with live counters.', '', '[]', 'gold', 550, 'per guest', 'single', 2),
...
('cater-traditional-01', ARRAY['housewarming','traditional_home_function','haldi_function','shrimantha_karya','half_saree_function'], 'catering', 'cat-general', 'Traditional Vegetarian Feast', 'Full traditional South Indian vegetarian feast for the ceremony.', '', '[]', 'standard', 320, 'per guest', 'single', 5)
ON CONFLICT (id) DO UPDATE SET supported_event_types = EXCLUDED.supported_event_types;
...
('addon-music-dj', ARRAY['wedding','engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'additional_services', 'addon-services', 'Music / DJ', 'Live DJ and sound setup for the event.', '', '[]', 'standard', 30000, 'per event', 'single', 5),
('addon-nadaswara', ARRAY['wedding','haldi_function','traditional_home_function','shrimantha_karya','half_saree_function'], 'additional_services', 'addon-services', 'Nadaswara', 'Traditional Nadaswaram performance troupe.', '', '[]', 'standard', 20000, 'per event', 'single', 6),
...
('addon-return-gifts', ARRAY['wedding','birthday','reception','anniversary','get_together','housewarming','haldi_function','traditional_home_function','shrimantha_karya','half_saree_function'], 'additional_services', 'addon-services', 'Return Gifts', 'Curated return gifts for guests.', '', '[]', 'standard', 150, 'per guest', 'stepper', 10),
...
('addon-anchor', ARRAY['wedding','engagement','reception','birthday','anniversary','get_together','bachelor_party','housewarming','haldi_function','corporate_event','traditional_home_function','shrimantha_karya','half_saree_function','other_events'], 'additional_services', 'addon-services', 'Anchor / Host', 'Professional event anchor or emcee.', '', '[]', 'standard', 10000, 'per event', 'single', 16),
...
('addon-purohit', ARRAY['wedding','housewarming','haldi_function','traditional_home_function','shrimantha_karya','half_saree_function'], 'additional_services', 'addon-services', 'Purohit / Pandit Services', 'Experienced purohit for rituals, samagri and muhurtham guidance.', '', '[]', 'standard', 15000, 'per event', 'single', 22),
