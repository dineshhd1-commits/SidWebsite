...
('photo-hall-candid-video', ARRAY['wedding'], 'photography', 'photo-wedding-hall', 'Cinematic Videography', 'Cinematic candid videography coverage of the wedding hall reception.', '', '[]', 'gold', 40000, 'per event', 'team_size', '{"teamSize": 2}', 7)
ON CONFLICT (id) DO UPDATE SET supported_event_types = EXCLUDED.supported_event_types;
