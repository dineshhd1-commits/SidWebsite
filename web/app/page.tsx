...
export default function HomePage() {
  ...
  const pillars = [
    {
      ...
      img: toAssetUrl('/photography-videography-collage.jpg'),
      badge: 'PHOTOGRAPHY',
      href: '/gallery',
      cta: 'Explore Gallery',
    },
    {
      ...
      img: toAssetUrl('/sid-party29.jpeg'),
      badge: 'DECORATION',
      href: '/gallery',
      cta: 'Explore Gallery',
    },
    {
      ...
      img: toAssetUrl('/onam-sadhya-lunch-menu-1.webp'),
      badge: 'CATERING',
      href: '/gallery',
      cta: 'Explore Gallery',
    },
  ...
  const galleryShowcase = [
    ...
    },
    {
      ...
      url: toAssetUrl('/sid-party9.jpeg'),
    },
    {
      title: 'Vibrant Floral Wall Art Decoration',
      category: 'manthapa',
      categoryLabel: 'Manthapa',
      url: toAssetUrl('/sid-party22.jpeg'),
    },
    {
      title: 'Live Auspicious Nadaswaram & Thavil Recital',
      category: 'rituals',
      categoryLabel: 'Rituals',
      url: toAssetUrl('/ChatGPT Image Jul 28, 2026, 04_57_21 PM.jpg'),
    },
  ];
