              ...
              {visibleItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    role="button"
                    tabIndex={0}
                    onClick={() => onToggleItem(category.id, category.name, item.id, item.name)}
                    onKeyDown={(e) => {
                    ...
                    className={`group text-left rounded-xl border overflow-hidden cursor-pointer transition-all hover:shadow-lg hover:-translate-y-0.5 ${
                      isSelected ? 'border-gold-500 ring-2 ring-gold-400 bg-gold-50' : 'border-gold-200 bg-white'
                    }`}
                  >
                    <div className="relative">
