...
export const MOCK_CATALOG_ITEMS: CatalogItem[] = [
  ...
  item({ id: 'dec-venue-muhurtha-mantapa', supportedEventTypes: ['wedding'], categoryKey: 'decoration', groupId: 'dec-venue', name: 'Muhurtha Manthapa Decoration', description: 'Traditional decoration of the muhurtha manthapa for the ceremony.', imageUrl: '', packageLevel: 'gold', price: 25000, unit: 'per event', displayOrder: 6 }),
