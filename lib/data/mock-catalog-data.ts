...
export const MOCK_CATALOG_ITEMS: CatalogItem[] = [
  ...
  item({ id: 'photo-hall-traditional-video', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Traditional Videography', description: 'Classic full-event traditional videography of the wedding hall reception.', imageUrl: '', packageLevel: 'normal', price: 15000, unit: 'per event', quantityMode: 'team_size', metadata: { teamSize: 1 }, displayOrder: 2 }),
  ...
  item({ id: 'photo-drone', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Drone', description: '4K aerial drone coverage of the venue and celebrations.', imageUrl: '', packageLevel: 'gold', price: 20000, unit: 'per event', displayOrder: 5 }),
  ...
  item({ id: 'photo-wedding-live-streaming', supportedEventTypes: ['wedding'], categoryKey: 'photography', groupId: 'photo-wedding-hall', name: 'Live Streaming', description: 'Live stream the wedding for guests who cannot attend.', imageUrl: '', packageLevel: 'premium', price: 15000, unit: 'per event', displayOrder: 7 }),
